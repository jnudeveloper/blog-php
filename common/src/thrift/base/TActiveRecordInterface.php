 ...
 * @since 2.0
 */
interface TActiveRecordInterface
{
    /**
     ...
     *
     * @param Query query
     * @return TActiveRecord the newly created [[ActiveQueryInterface]] instance.
     */
     ...
     * @return TActiveQueryInterface the relational query object
     */
     ...
     * @param string $name the relation name, e.g. `orders` for a relation defined via `getOrders()` method (case-sensitive).
     * @param TActiveRecordInterface|array|null $records the related records to be populated into the relation.
     * @since 2.0.8
     */
    ...
    /**
     * Returns the service used by this AR class.
